...
def default_loader(root_path, path):
    return Image.open(root_path + path).convert('RGB')
...
class ImageFolder(data.Dataset):
    ...
    def __init__(self, image_list, root_path, transform=None, target_transform=None, return_paths=False,
    ...
    def __getitem__(self, index):
        ...
        img = self.loader(self.root_path, path)
        #if self.train:
