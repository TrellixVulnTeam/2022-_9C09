...
def split_cluster_acc_v1(y_true, y_pred, mask):#旧类新类分别计算聚类准确度
    ...
    total_acc = weight * old_acc + (1 - weight) * new_acc#总聚类精度是加权计算得到的

    return total_acc, old_acc, new_acc


def split_cluster_acc_v2(y_true, y_pred, mask):#一个复杂的矩阵方式计算聚类准确度
    """
