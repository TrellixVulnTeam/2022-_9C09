...
parser.add_argument('--source_path', type=str, default='./office31_label/amazon_source0.6.txt', metavar='B',
                    help='checkpoint path')
parser.add_argument('--target_path', type=str, default='./office31_label/webcam_target0.6.txt', metavar='B',
                    help='checkpoint path')
parser.add_argument('--root_path', type=str, default='/home/chenziliang/ALEX_C/ADW/Office31/', metavar='B',
                    help='checkpoint path')
